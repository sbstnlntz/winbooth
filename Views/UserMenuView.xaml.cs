...
namespace FotoboxApp.Views
{
    public partial class UserMenuView : UserControl
    {
        ...
        {
            // Navigation zurück zur StartView, mit demselben ViewModel!
        ...
        private void CameraSettings_Click(object sender, RoutedEventArgs e)
        {
            ...
            var dlg = new CameraSelectDialog(vm.AvailableCameras, vm.SelectedCameraName); // Der Dialog muss so heißen!
